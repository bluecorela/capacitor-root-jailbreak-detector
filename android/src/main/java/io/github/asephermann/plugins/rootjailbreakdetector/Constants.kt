...
class Constants private constructor() {
    companion object {
         ...
         * @see [
         * @see [
        ](https://owasp.org/www-project-mobile-top-10/2014-risks/m10-lack-of-binary-protections)](https://owasp.org/www-project-mobile-top-10/2016-risks/m8-code-tampering) */
        ...
        val SU_PATHES = listOf(
            ...
            "/system/bin/failsafe/",
            "/system/sd/xbin/",
            "/system/xbin/",  // added from https://github.com/jacer2020/jacer2020/blob/49ce0b3d137adc21437c72a4c77ef91097df11ad/jsdroid-commons/src/main/java/com/jsdroid/commons/RootHelper.java#L27
            "/su/bin/",
            "/su/xbin/",
            "/ipcData/local/",
            "/ipcData/local/xbin/",  // added from https://blog.netspi.com/android-root-detection-techniques/
            "/system/usr/we-need-root/",
            "/system/usr/we-need-root/su-backup/",
            "/system/xbin/mu/",  // added from https://github.com/dmsyudis/Root_detect_3method_security/blob/24e0141c467ca2c9d9375ee66f4bf92944ca2a7c/app/src/main/java/com/duakoma/root_detect_3method_security/MainActivity.java
            "/magisk/.core/bin/"
        )
    }
